...
The battleship fires even if a position has already been marked. this must be done because an enemy support ship
could heal a damaged ship, if there was a check I could no longer sink the hit and then healed ship.
